package net.mcreator.dragonmine;
...
@Mod("dragonmine")
public class DragonmineMod {
	public static final Logger LOGGER = LogManager.getLogger(DragonmineMod.class);
	public static final String MODID = "dragonmine";

	public DragonmineMod(IEventBus modEventBus) {
